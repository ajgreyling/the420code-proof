...
@@DOMAIN Cosmology
@@SUB The sky’s history from the crack to the beat — the storm, the lock, the balance named, the two counts, one rate, and the settled rate counted
...
**Two measured quantities enter, and one stance is inherited.** The sky’s light census sets the handover epoch, taken as AP46 takes α and mₑ from the table, named in §9. The count in front of G sets the absolute rate; its known route is named in §5 and two of its three steps are the corpus’s; the third is booked as D-ASM.2, load-bearing, with a candidate reading recorded and not claimed. The constant-ε reading of the late universe is AP46’s frozen stance, inherited as a rider; §8 states what the tail does to the number and what AP42’s feeding history could do to it, which is unbounded until D48 is paid.
...
The storm’s length and the count that completes the assembly are not in the words. They are said to be open, and the roof’s date is said to be bounded, not derived. One reading of the doors transfer that would have given a length is shown dead in §3: eighteen serial stages on the electron tick take 87 million years, fifteen orders past the paper’s own switch. The transfer carries no timetable, and the storm’s clock — the primer’s input E — is not ruled.
...
Section 3 (The Storm). DERIVED — the exponential on the stated linearity; the doors as the rope order STATED, a transfer of the family’s law, watched and not used as the era mechanism, carrying no timetable, its serial reading SHOWN DEAD; the length OPEN; the storm’s clock NOT RULED.
...
KS-ASM.2 — the balance. LIVE — STRUCTURAL and EMPIRICAL: the square, flatness, the two counts, the ε in the balance, the D48 sensitivity; and, as an internal clause, the accumulation step of the count in front of G.
...
D-ASM.1. The storm’s length — the count that completes the assembly; how long a door takes to install on the records it needs. OPEN; not load-bearing for any switch, because the roof’s date is bounded by nature on both sides.

D-ASM.2. The accumulation step of the count in front of G. The count 8π/3 is not an unknown of the arena: once G is the inverse-square coupling — which AP28’s and AP44’s landing on Newton’s G presupposes — the shell route fixes it as two times the unit ball, and the unit ball is the room’s three. What the words do not force is the two: the stretch’s accumulated push against the hold, the half in the square. A candidate reading — the push integrated over the growth, AP45’s line that integrates, licensed by the author’s ruling of 11 August that records are never destroyed and energy is the holder of the standing record — is recorded in §5 as CANDIDATE, found with the target known, and not claimed. OPEN, narrowed to that step; load-bearing for every absolute rate in §9; carried on KS-ASM.2 as an internal clause.
...
**The eighteen and the three** — AP28’s face-projections and actualization gates. **The horse** — propagation, c; **the handler** — the arena; **the ropes** — the constraint; **taut** — c engaged.
...
**The count in front of G, located.** k is not an unknown of the arena’s geometry, and v0.2’s “a count of the π-kind” was the wrong frame. Its value is tied to what G means: G is the inverse-square coupling, F = GMm/r², with the 4π of the field equation left unrationalised; write G′ = 4πG and the same balance reads stretch² = (2/3)·G′·ρ. The corpus’s G is Newton’s G — AP28’s and AP44’s formulas land on the tabulated 6.674 × 10⁻¹¹, so they are formulas for the inverse-square coupling and the convention is already absorbed there. Given that, the count has one known route, the shell argument of the standard account (McCrea and Milne, 1934), in three steps. First, the hold on the edge of a room of size a is the inverse-square pull of the census inside it, everything outside cancelling — the author’s own sentence, “cancels where the horse is equally far from every wall.” Second, the census inside is ρ times the room’s volume, (4π/3)·a³ — the unit ball, the room’s three, AP24’s. Third, the stretch’s accumulated push against the hold is exact: ½ȧ² = G·M/a, nothing left over. Then ȧ²/a² = 2 × (4π/3) × G·ρ = (8π/3)·G·ρ. Of the three steps, the first and second are the corpus’s own objects. The third — the half, the accumulation of the push over the growth — is the one step the author’s words do not force, and it is D-ASM.2, narrowed to exactly that. A candidate reading exists and is recorded as such: the push integrated over the growth is half the square, AP45’s line that integrates; and the energy form of the balance would be licensed by the author’s ruling of 11 August that records are never destroyed, only reconfigured, and that energy is the holder of the standing record. That candidate was found with 8π/3 in view, by four readers independently, and is graded CANDIDATE, not claimed; it is walked at the author’s word or it stays in the drawer. The nuclei fix k to a few per cent either way, and of the corpus’s own π-vocabulary they leave only 2 × (4π/3) standing. Nothing in the shapes of §6 depends on k; the epochs and rates of §9 do.

**The same route, and flatness again.** The shell argument also says what an inexact balance leaves: a term going as one over the room’s size squared, the curvature term. The 1:1’s exactness is the vanishing of that term. Flatness, ruled from the author’s sentence above, is the route’s own statement read back. One warning the corpus owes itself: the two in the count is the escape-speed factor — a flat room grows at exactly the escape speed of its own census — and the word “escape” there has nothing to do with AP46’s escape count. Same spelling, different object.
...
**The first minutes’ nuclei.** PASS — with one dependency named. The expansion rate at the temperatures of the first minutes is the equation’s with light dominant; its absolute value carries the count in front of G. At 8π/3 it is the standard rate, and the helium and deuterium yields fix that rate to a few per cent, the bound usually quoted as the number of light relativistic species. The dependency is D-ASM.2 as narrowed in §5: the accumulation step of the shell route.

**The relic glow.** PASS — with the same dependency; and the glow is §6’s first thinning seen directly: 3000 K at last scattering, 2.725 K now, the line paying the whole stretch.
...
No target fails. Two lines pass on counts, one with an input, two with a dependency, one with a rider, and one is bounded; every line says which.
...
It does not derive the count in front of G. It locates it — two of the shell route’s three steps the corpus’s, the third a candidate found with the target in view — and books the third as load-bearing.
...
**Test.** Structural: fires if any recorded era requires the additive entry of the ε or a thinning count other than four and three; fires if AP42’s feeding history, once written (D48), moves the pure number of §8 by more than the window can carry. Internal, on D-ASM.2: fires if the corpus’s own account of the accumulation step, when written, yields anything but the two — a self-consistency clause, since any account consistent with Newton’s G must land there; it tests the corpus’s work, not nature. Empirical: the light-element yields and the relic glow’s rate at their current bounds; the growth shapes at high redshift; the sky’s curvature share, which fires the flatness ruling if found non-zero beyond a part in a thousand.
...
Lineage: v0.1, the desk draft, 3 September 2026, retained → v0.2, same date, after four independent reviews of v0.1, retained → this v0.3, 4 September 2026, after the author sent the open-derivations list to six readers and the desk checked every return. The Artist’s Note is drafted from the author’s words and awaits his hand.
...
*[Not locked. Desk draft v0.3 awaiting the author’s walk, the Artist’s Note in his hand, his word on the KS-45.1 ruling and on the accumulation step, and independent review. Expected ceiling on lock: forcing — the accumulation step of the count in front of G at candidate grade, the feeding history’s sensitivity unbounded; declared.]*
...
Section 5 (The Balance, Named). RULED; DERIVED; IDENTIFIED. The 1:1 with the cost paid; direction before pace; the square from G’s dimensions; flatness from the exact 1:1; the order on record; the equation named as Friedmann’s; k located — the shell route, two steps the corpus’s, the accumulation step D-ASM.2 with a candidate reading; the route’s leftover as the curvature the 1:1 forbids.
...
The proof names the equation it arrives at, names its two inputs and its rider where they enter, locates the count it did not derive and names the one step still open in it, shows the corpse of the entry it refused and the corpse of the timetable it withdrew, states the one step it found in the wrong order, shows the two pre-registered items it missed, fires its own corpus’s switch on the page, and takes a side it can lose.
...
D-ASM.1 (the storm’s length, the completing count, the storm’s clock). D-ASM.2 (the accumulation step of the count in front of G; load-bearing). D-ASM.3 merged into §8 and D48. Inherited: D-CCC.1 and D-BLINK.1 (the record algebra); D48 (AP42’s feeding history; its sensitivity on the rate declared, unbounded).
