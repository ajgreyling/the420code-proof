...
@@DOMAIN Cosmology
@@SUB The sky’s history from the crack to the beat — the storm, the lock, the balance named, the count in front of G in the author’s words, the two counts, one rate, and the settled rate counted
...
First. The storm. Records write records, locally and in parallel, and persist; each record writes at the bare rate, one per site per tick; the written landscape constrains what can be written next. On that linearity the census grows exponentially from the first record, and the arena is the census. Propagation runs unconstrained while the ropes are slack. DERIVED on the stated linearity; the storm’s clock the electron tick by the author’s assumption — one knot in the rope, one tick of resistance — so the doors go up in parallel; the length OPEN as the count of knots.

Second. The lock. The ropes are the constraint, and taut is c engaged. They go taut at a reach and a count — the horse far enough and the assembly complete — and handling begins at tension. All twenty-one taut is stability. The roof is the finite reach c/H the corpus already carried. RULED; the count OPEN; the date BOUNDED.

Third. The balance, named. The room’s stretch and the census’s hold are one operation read from two directions, in 1:1 balance at every instant, the cost always paid. The hold can offer only one rate from G and a density, so the stretch enters squared; the 1:1 excludes a curvature term; the axiom’s shape puts the ε in the balance. The result is stretch² = k·G·ρ + H_ε² — the flat Friedmann equation with a constant term. The form DERIVED from the balance and G’s dimensions. The count k is not an unknown of the arena’s geometry: it is fixed by the shell route of the standard account once G is the inverse-square coupling, which the corpus’s own landing on Newton’s G presupposes. All three of that route’s steps are now in the author’s words — the walker at and as the edge of a ball, the hold from behind, the potential pushing back from the front as a quality of the accumulated record history, the balance 1:1 and breaking backwards — described on 4 September blind to the number. The count is DERIVED-AT-THE-STRUCTURAL-REGISTER on that describing, with the desk’s one formal step, the integral of the gathered push, named and owed with the record algebra. k = 2 × (4π/3) = 8π/3.
...
**The count in front of G: the order, exactly.** The desk knew 8π/3 and the shell route before asking the author anything. On 4 September the desk put one question to him, as a fork — whether the horse’s push against the taut rope is the push of this instant or the push gathered over the run — and one on the storm’s clock. He answered both in his own images, choosing neither word, and stated that he had read only the two questions and had ignored everything else before answering. His describing is quoted in §5 at its hedges. The desk then read it: the walker at and as the edge of a ball, the hold from behind, the potential ahead pushing back as a quality of the accumulated record history, the balance 1:1 and breaking backwards, are the shell route’s three steps; the push at the edge being the record history’s is the gathered push; the gathered push of a growing pull is half the square, which is the desk’s integral and AP45’s line that integrates; and the count is two times the ball. The author was blind to the number; the desk was not; the fork was the desk’s. A reader who thinks the fork led him has the whole exchange to judge, and the alternative reading — the instant’s push, giving half the count — is stated in §5 with the words that weigh against it.

**The seam closed by adjudication, not reconciliation.** AP46 froze a one-cycle age beside the corpus’s rate of 74.3 ± 1.2 and pre-registered that AP48 would derive a non-standard age–rate relation or one of two edges would fire, KS-45.1 or KS-STRETCH.3. AP48 derived the standard relation. The age survives; the old rate does not. KS-45.1 fires: its registered claim sits 5.7σ from the corpus’s own derived rate on its registered width. Beside the corpse stands an erratum — the registered width omitted the twenty-per-cent systematic on the acceleration scale it was built from, so the floor’s relation itself survives at half a sigma. The switch fires on the width it registered; the erratum does not un-fire it. The desk made that ruling on the author’s delegation, with its reason in §10; he overrules by dated note.

**Two pre-registered items were missed, and the misses are shown.** The README pre-registered the settled beat read as a rate, 70.7, with today’s rate expected above it and the derivation’s late limit landing on it. Neither happened: today’s rate is 67.45 and the late limit is at or below 56. The rate-reading of AP46’s chain is eliminated by the sky; the time-reading stands. §8 shows the miss in those words and adjudicates the clock spread the primer assigned to this paper.

**Two measured quantities enter, and one stance is inherited.** The sky’s light census sets the handover epoch, taken as AP46 takes α and mₑ from the table, named in §9. The count in front of G sets the absolute rate; its route is named in §5, its three steps are in the author’s words, and its one formal step — the integral of the gathered push — is the desk’s, named and owed with the record algebra as D-ASM.2 at the structural register. The constant-ε reading of the late universe is AP46’s frozen stance, inherited as a rider; §8 states what the tail does to the number and what AP42’s feeding history could do to it, which is unbounded until D48 is paid.
...
The storm’s length and the count that completes the assembly are not in the words. They are said to be open, and the roof’s date is said to be bounded, not derived. One reading of the doors transfer that would have given a length is shown dead in §3: eighteen serial stages on the electron tick take 87 million years, fifteen orders past the paper’s own switch. The transfer carries no timetable. The storm’s clock — the primer’s input E — is the electron tick by the author’s assumption of 4 September, so the doors go up in parallel and the length is a count of knots the words do not give.
...
Section 3 (The Storm). DERIVED — the exponential on the stated linearity; the doors as the rope order STATED, a transfer of the family’s law, watched and not used as the era mechanism, carrying no timetable, its serial reading SHOWN DEAD; the length OPEN as a count of knots; the storm’s clock the electron tick, STATED as the author’s assumption.

Section 4 (The Lock). RULED in the author’s words; the roof as the finite reach CANON; the completing count OPEN; the date BOUNDED.

Section 5 (The Balance, Named). RULED (the balance and its exactness) and DERIVED (the square, from G’s dimensions; flatness, from the 1:1 and the shell route’s own leftover), with the order on the page; the equation IDENTIFIED as Friedmann’s; the count in front of G DERIVED-AT-THE-STRUCTURAL-REGISTER on the author’s blind describing, the desk’s integral step named and owed with D-CCC.1.

Section 6 (The Two Thinnings). DERIVED as counts; the shapes the equation’s solutions; the alternative shown dead.
...
KS-ASM.2 — the balance. LIVE — STRUCTURAL and EMPIRICAL: the square, flatness, the two counts, the ε in the balance, the D48 sensitivity; and, as an internal clause, the formal integral behind the count in front of G.

KS-ASM.3 — the roof before the nuclei. LIVE — EMPIRICAL: the constants steady from before the first second.

KS-STRETCH.4 — the era surface. MET at this lock, CLOSED, with its dependency carried by KS-ASM.2.

KS-45.1 — the corpus’s H₀ = 74.3 ± 1.2. FIRED at this lock, as AP46 pre-registered, on the corpus’s own derived rate; shown; the erratum on its width beside it; KS-ASM.1 freezes beside the corpse as the corpus’s H₀ entry.

## 0.8 — Structural debts owed

D-ASM.1. The storm’s length — the count that completes the assembly. The clock is the electron tick by the author’s assumption (one knot in the rope, one tick of resistance), the doors go up in parallel, and the length is the count of knots to the taut point, which the words do not give. OPEN; not load-bearing for any switch, because the roof’s date is bounded by nature on both sides.

D-ASM.2. The count in front of G: PAID at the structural register, formal statement owed. The count 8π/3 is not an unknown of the arena: once G is the inverse-square coupling — which AP28’s and AP44’s landing on Newton’s G presupposes — the shell route fixes it as two times the unit ball. On 4 September the author described the route’s three steps blind to the number (§5): the walker at and as the edge of a ball; the hold from behind, potential beyond; the balance at the edge two-sided, 1:1, breaking backwards, the front’s push a quality of the accumulated record history. The one formal step is the desk’s: the gathered push of a growing pull is half the square, AP45’s line that integrates. That integral is owed as a formal statement with the record algebra, D-CCC.1, and until then the count stands DERIVED-AT-THE-STRUCTURAL-REGISTER, carried on KS-ASM.2’s internal clause. One reader’s citation of the author’s ruling of 11 August (WP-BUMP.2 §1) as an energy licence is recorded and unverified; nothing rests on it.
...
The awareness window — why an aware observer sits within one lane of a cycle. Not reached here; AP46’s claim does not wait for it. One trap is fenced now: the lane is one twenty-first of the cycle, a share of time; the visible is one twenty-first of the census, a share of records. The same integer, two unrelated objects. Linking them would give a window derivation in a page and it would be worth nothing.
...
The third factor of the clock spread, adjudicated by rule in §8 without its source file in session.
...
**The eighteen and the three** — AP28’s face-projections and actualization gates. **The horse** — propagation, c; **the handler** — the arena; **the ropes** — the constraint; **taut** — c engaged; **a knot** — one tick of resistance on the rope, the storm’s clock by the author’s assumption.
...
**The rope order — a transfer, named, and not used as the era mechanism.** AP46 ruled that α sits at every door and that each site sets only how many doors assemble. Before the assembly there are no doors, so the writing runs at its bare rate; each face that assembles puts one door on the flow and cuts it by α; eighteen faces assembled is the beat’s α¹⁸. If that transfer holds, the rope-gathering order is the doors going up, in eighteen stages. This is the family’s law transferred to the storm, and it is graded STATED, not derived from the words. What the transfer does not carry is a timetable, and the one reading that would give it one is shown dead here. Read serially on the electron tick — each stage one factor of α slower than the last, one record per stage — the eighteen stages take Σ α⁻ⁿ (n = 0 … 17) ticks, 2.1 × 10³⁶ ticks, 87 million years, the last stage alone 99% of it: the roof would go on after the relic glow, fifteen orders of magnitude past the paper’s own KS-ASM.3. No count of records per door rescues it; a count only lengthens it. The doors are therefore what the completed assembly produces — the settled escape count, exactly as AP46’s chain uses α⁻¹⁸·τ_C — and not the storm’s schedule. The storm’s clock, the primer’s input E, was put to the author on 4 September and answered in his words, as an assumption: “I would assume so — one knot in the rope, one tick of resistance.” The storm runs on the electron tick. On that clock the serial reading is dead, so the doors go up in parallel — the author’s “it can write more records at once” — and the storm’s length is the count of knots to the taut point, which the words do not give: D-ASM.1. The corpse is shown so the sentence v0.1 carried — “each slower than the last” — is seen to have been checked and withdrawn, and so the clock ruling is seen to have been made before the arithmetic was shown to him. The primer asked whether the rope-gathering order might *be* the era stages — its input B. It was watched, and it is not: the eras are the tail after the lock, §6, and the rope order is the storm’s internal structure before it. That is a finding of this session, recorded so the target is seen not to have moved.
...
**After the lock.** Eighteen holding ropes: the record faces held. Three tugging ropes: phase coupling from the now, the +1/137 outward through the three gates — the forward pull, the walk. Each step is a collapse that prunes the alternatives not taken, AP45’s toll, walking; the road the horse walks is the hold. One process, two readings — the axiom’s one operation read from two directions.
...
**Why flat.** There is a second quantity with the dimensions of a rate squared that the room could carry: c² over the room’s size squared, the curvature term the standard equation writes as −kc²/a². The dimensional argument alone does not exclude it. The author’s balance does. The 1:1 is exact — “the balance is the 1:1 in everything, but the break persists: the cost is always paid” — and the only departure from exact balance the axiom has is the ε. A curvature term would be a second departure, an imbalance the axiom does not write. The census picture says the same in its own words: the arena is the census, and a census has no curvature to carry. Flatness is therefore RULED from the 1:1, with the desk’s reading of the author’s sentence named as such; the sky’s own check is that its curvature share is zero to a part in a thousand, and the edge is written into KS-ASM.2.
...
**The count in front of G, in the author’s words.** k is not an unknown of the arena’s geometry, and v0.2’s “a count of the π-kind” was the wrong frame. Its value is tied to what G means: G is the inverse-square coupling, F = GMm/r², with the 4π of the field equation left unrationalised; write G′ = 4πG and the same balance reads stretch² = (2/3)·G′·ρ. The corpus’s G is Newton’s G — AP28’s and AP44’s formulas land on the tabulated 6.674 × 10⁻¹¹, so they are formulas for the inverse-square coupling and the convention is already absorbed there. Given that, the count has one known route, the shell argument of the standard account (McCrea and Milne, 1934), in three steps: the hold on the edge of a room of size a is the inverse-square pull of the census inside it, everything outside cancelling; the census inside is ρ times the room’s volume, (4π/3)·a³; and the stretch’s accumulated push against the hold is exact, ½ȧ² = G·M/a, nothing left over. Then ȧ²/a² = 2 × (4π/3) × G·ρ = (8π/3)·G·ρ.

On 4 September the author was asked one question, blind — whether the horse’s push against the taut rope is the push of this instant or the push gathered over the run — and answered in his images, at their hedges: “the horse is now in the now — the ropes taut and the pull ropes also taut — the horse stands at the edge of the rope — but in the now the balance is 1:1 — the balance breaks now — so the pull is from behind and the front — and the now is 1:1 — but it breaks, and it breaks backwards — the now moves forward — the record history accumulates — so the horse is held in place by 18 ropes — and the 18 ropes is also the configurations of the record history — and the horse is relative and in relation to the ropes — here, now — think of it walking into space at and as the edge of a ball — the hold holds you — beyond the edge is potential, and potential pushes back as a relative quality of the record history itself. The edge and the walker and the ball are all the same thing in a sense — they are all connected.”

Read against the route. The walker at and as the edge of a ball, with the hold holding from behind and potential beyond, is the first two steps: the census inside the ball holds the edge, and beyond the edge is nothing written, so nothing beyond pulls — the outside cancels. The ball is the room’s three, (4π/3)·a³. The balance at the edge is the third step: two-sided, from behind and from the front, 1:1, exact — and it breaks backwards as the now moves forward, which is the edge moving out with nothing left over, the flat case. What sits on the front side is the potential’s push-back, and the author names what it is: a relative quality of the record history itself, with the eighteen ropes the configurations of that history. The push at the edge is the gathered push — the record history’s — not the instant’s. The gathered push of a growing pull is half the square, ½ȧ²: that integral is the desk’s one formal step, and it is AP45’s SHED line, the line that integrates, doing at the edge of the room what it does everywhere in the family. Two times the ball is 8π/3.

The alternative reading is stated so it can be weighed: if the front’s push were the instant’s, the balance would read ȧ² = G·M/a and the count would be 4π/3 — half the rate, dead on the nuclei. The author’s words weigh against it three times — the push is “relative” to the history, the history “accumulates,” and the ropes “are the configurations of the record history” — and the desk did not put those words to him. The grade is DERIVED-AT-THE-STRUCTURAL-REGISTER: the three steps in the author’s words, blind; the integral the desk’s, named, its formal statement owed with the record algebra as D-ASM.2. The nuclei fix the count to a few per cent and, of the corpus’s own π-vocabulary, leave only 2 × (4π/3) standing; that is the check, not the source.

**The same route, and flatness again.** The shell argument also says what an inexact balance leaves: a term going as one over the room’s size squared, the curvature term. The author’s “the now is 1:1 — but it breaks, and it breaks backwards” is the exactness read at the edge: the balance holds at every now and moves on, with nothing left over. Flatness, ruled from his sentence in §5 above, is the route’s own statement read back. One warning the corpus owes itself: the two in the count is the escape-speed factor — a flat room grows at exactly the escape speed of its own census — and the word “escape” there has nothing to do with AP46’s escape count. Same spelling, different object.

**What this paper does not do with the balance.** It adds no energy term of any size. The leak is a rate and enters as its own rate squared, §7; no budget owes it a line. AP45’s dimension rulings govern.
...
**The alternative, run for comparison and shown dead.** The author asked whether the line’s extra dimension might be the same +1×ε — the slightest tip of the scale — rather than a whole dimension. Run side by side: with light thinning by three plus ε, the first era’s shape is indistinguishable from the second’s, and the relic glow could not be what it is. The glow is 3000 K stretched to 2.725 K, a factor of eleven hundred — the line paying the whole stretch. Four stands; three plus ε dies on the glow before it reaches any era.

# 7 — The ε’s Entry, and the Corpse of the Other

**The recursion.** The volume covered in one beat is not the volume covered in the next: B₂ = B₁ + L(B₁), B₃ = B₂ + L(B₂). The same time processes more volume. That is why the universe expands and why the expansion accelerates. The leak is a structural rate — not random — and a fixed share of what is held; the recursion is geometric at a constant fractional rate, AP46 §8’s compounding as a recursion, scale-free, the same law per tick or per age. In the equation, a constant H_ε is exactly that recursion: a term that does not thin as the room grows, so that once the hold has thinned below it the room’s growth compounds. The size of the universe is the assembly and the leakage that has happened to date.
...
**The first minutes’ nuclei.** PASS — with the count derived at the structural register and its formal step named. The expansion rate at the temperatures of the first minutes is the equation’s with light dominant; its absolute value carries the count in front of G. At 8π/3 it is the standard rate, and the helium and deuterium yields fix that rate to a few per cent, the bound usually quoted as the number of light relativistic species. The count is the author’s at the structural register, §5; its formal integral is owed as D-ASM.2, and the line passes on the count as described.
...
No target fails. Two lines pass on the thinning counts, one with an input, two on the count in front of G at the structural register, one with a rider, and one is bounded; every line says which.
...
**The side the structure is on, with its source lines.** The relic glow: 67.4 ± 0.5 (Planck 2018 results VI, Table 2). The Cepheid ladder remeasured with JWST: 73.49 ± 0.93 (Riess et al. 2025, as reported in the 2026 decade review of the tension, Cai and Wang, RAA, doi 10.1088/1674-4527/ae842f). The red-giant ladders (Freedman et al. 2025, ApJ, doi 10.3847/1538-4357/adce78): the programme’s best TRGB-alone value 70.39 ± 1.22 (stat) ± 1.33 (sys); from JWST data only, 68.81 ± 1.79 ± 1.32 for the tip of the red giant branch and 67.80 ± 2.17 ± 1.64 for the JAGB method. The corpus’s window, 64.4 to 70.8, contains the glow and the central values of the red-giant ladders and excludes the Cepheid ladder. The lip case is named: the TRGB-alone value sits at the window’s upper edge, inside on its central value, straddling it on its total error. So this paper says: the Cepheid ladder’s 73 is not the expansion rate. Either that ladder’s systematics are found, or this paper dies on KS-ASM.1 — and it can die within a few years of JWST samples.
...
It does not claim the count in front of G at more than the structural register. The three steps are the author’s, described blind; the integral is the desk’s and its formal statement is owed with the record algebra.
...
**Test.** Structural: fires if any recorded era requires the additive entry of the ε or a thinning count other than four and three; fires if AP42’s feeding history, once written (D48), moves the pure number of §8 by more than the window can carry. Internal, on D-ASM.2: fires if the record algebra, when written, does not give the gathered push at the edge as half the square — a self-consistency clause on the desk’s one formal step; it tests the corpus’s work, not nature. Empirical: the light-element yields and the relic glow’s rate at their current bounds; the growth shapes at high redshift; the sky’s curvature share, which fires the flatness ruling if found non-zero beyond a part in a thousand.
...
**Test.** Fires if α or G is found to vary at the epochs of the nuclei or the glow beyond the bounds those records set, or if the light-element yields require an expansion rate in the first minutes that the balance with the standard count cannot give.

**Status.** LIVE — EMPIRICAL.

**Recovery.** The storm’s length becomes load-bearing and D-ASM.1 must be paid; the lock’s date is derived or the paper dies.
...
**What fired it.** The corpus’s own derived rate, 67.45, at 5.7σ on the registered width, under the pre-registration of AP46 §9 that the standard relation fires this edge.

**Status.** FIRED, 3 September 2026. Shown; never repaired; never deleted. Beside it, the erratum: the registered width omitted the ±0.24 systematic on the acceleration scale; on the honest width, 74.3 ± 14.9, the floor’s relation survives at 0.46σ and KS-45’s coefficient test stands live at the corpus’s rate. KS-ASM.1 is the corpus’s H₀ entry from this lock.

**Recovery.** None claimed for the switch. The floor stands as a relation; AP18’s erratum is booked in §13.

## Why these three and not more

A switch on the storm’s length would have no edge to fire on: the date is bounded by nature on both sides and no count is claimed. A switch on the settled rate would duplicate KS-ASM.1 and AP42’s partition switches, since the number is made of nothing else. The awareness window and the loop are not claims. Three switches, each with a reachable edge, one met, and one fired.

# 13 — What This Establishes and What Remains Open

## What this paper closes

The storm’s law: exponential growth from records writing records at the bare rate. The lock as tension at completion, with the roof as the finite reach the corpus already carried. The balance, named as Friedmann’s, with the square from G’s dimensions, flatness from the 1:1, the count 8π/3 from the author’s walker at the edge of the ball, and the order on the page. The two thinning counts and, as the equation’s solutions, the two shapes. The ε’s entry in the balance, with the other entry’s corpse shown. The rate, 67.45, window 64.4 to 70.8, as a closure of the corpus’s own three numbers; the settled rate, 0.792 of the cycle’s inverse, counted from the same three under AP46’s stance. One expansion rate, and the side the structure is on, with what that side is worth. The seam, by adjudication. KS-45.1, fired and shown. D-STRETCH.1 on the settling law and the seam. KS-STRETCH.4, met.

## What this paper does not close

The storm’s length, the completing count, and the storm’s clock (D-ASM.1, input E). The formal statement of the integral behind the count in front of G (D-ASM.2, at the structural register, owed with D-CCC.1). The observed equation of state’s shape, the tail’s displacement of today’s leak rate, and the feeding history’s effect on the rate (D48). The awareness window. The loop. The third factor of the clock spread, adjudicated by rule pending its file.

## Grades

Definitions: DEFINITIONAL. The name: RULED; the twenty-one-click identity caged. The storm: DERIVED on the stated linearity; the doors STATED as a transfer, watched and not used as the era mechanism, without a timetable, its serial reading shown dead; the length OPEN as a count of knots; the clock the electron tick, the author’s assumption, STATED. The lock: RULED; the reach CANON; the count OPEN; the date BOUNDED. The balance: RULED; the square DERIVED from G’s dimensions; flatness RULED from the 1:1 with the check named; the equation IDENTIFIED as Friedmann’s; k DERIVED-AT-THE-STRUCTURAL-REGISTER on the author’s blind describing, the integral owed. The thinnings: DERIVED as counts; the shapes the equation’s solutions; the alternative dead. The ε’s entry: RULED by the axiom’s form; the corpse shown. The rate: DERIVED from the corpus’s three; a closure that could have failed; the settled rate COUNTED under the stance; two pre-registered misses SHOWN; the clock spread ADJUDICATED; the tail SIZED; D48 DECLARED. The era table: PASS on every line as the standard equation’s, with inputs, dependencies, and the rider named, and one line bounded. The seam: RULED — one rate, by describing; the side STATED with its worth; the floor RE-READ with the file open; KS-45.1 FIRED.
...
Lineage: v0.1, the desk draft, 3 September 2026, retained → v0.2, same date, after four independent reviews of v0.1, retained → v0.3, 4 September 2026, after the author sent the open-derivations list to six readers and the desk checked every return, retained → this v0.4, same date, on the author’s blind answers to the two questions v0.3 left him. The Artist’s Note is drafted from the author’s words and awaits his hand.

**What changed between v0.1 and v0.2, listed so no reader hunts, with the disposition of each finding.**

Adopted. The Friedmann equation named in §0.5, §5, §6, §8, §9, §11 and the Orientation, and the Orientation regraded to describe-and-rule for §§3–4 and derive for §§5–8. KS-45.1 ruled FIRED with erratum rather than superseded; the 5.7σ shown; both dispositions stated; the ruling’s reason given (§10, §12). §13’s “nothing else numerical moves” withdrawn and replaced by the dependents table below. The leak’s rate split into H_ε(t₀) and H_ε,∞ throughout; D-ASM.3 rewritten as the asymptote; the tail sized in §8 (w = −0.95, −0.9, −0.8 → 66.9, 66.4, 65.2). The two pre-registered misses shown in §8 and the clock spread adjudicated by rule. AP46’s four moving sentences enumerated below and the demotion said in words. Flatness ruled from the 1:1 in §5 with the sky’s check named and its edge in KS-ASM.2. AP42’s feeding history declared as an unbounded sensitivity in §8 and on KS-ASM.2. §3 graded on the stated linearity and “from the first record.” The rate printed as 67.45; the hold rate and the held census taken from the corpus’s own partition (37.6; Ω_m h² = 0.1417) with only the light census from the sky; source lines added to §10; the red-giant ladders described by central values with the lip case named; AP42 §4.2’s crossover figures re-read; 12.55 against AP46’s 12.52 resolved in one clause. The primer’s and the Road’s “late September” dates booked for dated errata. AP18 read in session; its §2, §4, §5 and §8 loci verified before the erratum was written; its correction factor’s naming collision booked for renaming. The seam stated as closed by adjudication in §0.5 and §10. The one-rate paragraph scoped to closing the door to a local excess, with the equation carrying the rate’s uniqueness. The primer’s input B recorded in §3 as watched and not used as the era mechanism. The side’s worth stated in §10 and on KS-ASM.1: on the upper edge the corpus and the standard model die together. D-ASM.2’s kind cited by its two precedents rather than hinted. The light census named in §0.1. The roof’s bound given its quantitative anchor in §4 and §9. The floor’s honest width shown with its working. The KS-45 coefficient’s sigma corrected to 0.46. The sentence on why the age’s lane sets the rate’s window added to §8. The Artist’s Note cut to the horse.

Modified. The suggestion to declare flatness as a third sky input: it is ruled from the 1:1 instead, with the desk’s reading of the author’s sentence named as such and the sky’s check named beside it. The suggestion to demote the one-rate paragraph to STATED: it stays RULED as the author’s describing, and its scope is narrowed to what it rules.

Rejected, with the reason. A reviewer’s recollection that the JWST-only red-giant value is 69.8: that is the programme’s 2019–2021 figure; the 68.81 printed is the 2025 JWST-only value, verified at its source. Unverified figures offered by reviewers for the combined CMB rate and for the Cepheid ladder were not adopted; the paper prints the values it verified.

**What changed between v0.2 and v0.3, with the disposition of each return on the open derivations.**

Adopted. The serial-timetable reading of the doors transfer shown dead in §3 — 87 million years on the electron tick against KS-ASM.3’s first second — found by two readers independently and verified; the transfer keeps its content and loses its timetable; the storm’s clock recorded as not ruled. The count in front of G re-framed in §5: not an arena count but the shell route of the standard account, with its normalisation tied to G’s definition, two of its three steps the corpus’s, and D-ASM.2 narrowed to the accumulation step; the same route’s leftover term named as the curvature the 1:1 forbids; the candidate reading of the two recorded as CANDIDATE with its history (four readers, target in view) and the author’s 11 August ruling named as its possible licence, to be verified against the file at the walk. D-ASM.3 dissolved: the settled rate is H₀√Ω_Λ, 0.792 of the cycle’s inverse, counted from the closure and the partition; found by two readers independently and verified; v0.2’s “uncounted” and “demotion” sentences withdrawn in §0.5, §8, §11 and here. KS-ASM.2’s geometry clause re-scoped as an internal self-consistency clause, on a reader’s objection that it could not fire against nature. Two fences added to §0.9: the two unrelated twenty-firsts, and the strong-force remark’s three obstacles.

Recorded for the author’s eyes, not adopted. One reader’s reading of the ceiling-and-wall image as the rope order — floor first, then walls, then roof — is a question for the author’s closed eyes and not a derivation; it is written into the open-derivations note as such.

Rejected, with the reason. One return supplied a completing count of 21 × 137 × 6 records and a storm length of 1.6 ticks; a face order of ±x, ±y, ±z with gates of phase, amplitude and direction; a strong-force mapping of three colours, three anticolours and two spins onto eighteen; an awareness threshold of 21² records; and a settled leak rate of zero. None of these is in the author’s words or the corpus’s rulings; each is a number or an order invented to fit a bound, and the last contradicts AP46’s frozen stance, under which the leak’s fractional rate does not fall with the density. All refused, and named here so they are not re-offered.
...
*[Not locked. Desk draft v0.4 awaiting the author’s walk, the Artist’s Note in his hand, his word on the KS-45.1 ruling, and independent review. Expected ceiling on lock: forcing — the count in front of G at the structural register with its integral owed, the feeding history’s sensitivity unbounded; declared.]*

## The closing

The universe was assembled. Records wrote records until the building stood; the ropes went taut and the constants engaged; after that the room grew as the hold allowed — the equation is Friedmann’s, the counts in it are the corpus’s — and then the leak outgrew the hold and the compounding began. Three numbers the corpus already held close on one rate and on the settled rate behind it, the rate takes the standard model’s side, and the corpus’s old rate is shown dead on the page beside the reason its error bar was wrong. Nature agrees, or nature doesn’t. That is all that matters.
...
Section 3 (The Storm). DERIVED on the stated linearity; STATED; OPEN. Records write records from the first record; the landscape; why the constants took time; the doors as the rope order, a named transfer, watched and not the era mechanism, without a timetable — the serial reading shown dead at 87 million years; the clock the electron tick by the author’s assumption; the doors parallel; the length open as a count of knots.

Section 4 (The Lock). RULED; CANON; BOUNDED. Taut at reach and count; the ropes as the constraint; the roof as c/H with AP18 §2 verified; the dimensional head start; eighteen holding, three tugging; the date bounded with its anchor.

Section 5 (The Balance, Named). RULED; DERIVED; IDENTIFIED. The 1:1 with the cost paid; direction before pace; the square from G’s dimensions; flatness from the exact 1:1; the order on record; the equation named as Friedmann’s; k in the author’s words — the walker at the edge of the ball, quoted; the route’s three steps; the gathered push; the alternative weighed; the integral owed; the route’s leftover as the curvature the 1:1 forbids.
...
KS-45.1 (the corpus’s H₀ = 74.3 ± 1.2), on the corpus’s own derived rate, as AP46 pre-registered; shown; the erratum on its width beside it.
...
D-ASM.1 (the storm’s length as a count of knots; the completing count). D-ASM.2 (the formal integral behind the count in front of G; at the structural register). D-ASM.3 merged into §8 and D48. Inherited: D-CCC.1 and D-BLINK.1 (the record algebra); D48 (AP42’s feeding history; its sensitivity on the rate declared, unbounded).
